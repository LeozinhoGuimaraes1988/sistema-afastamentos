...
import { checkCustomClaims } from '../../services/checkAuthClaims';
...
const Login = () => {
  ...
  const handleGoogleLogin = async () => {
    try {
      ...
      const { autorizado } = await checkCustomClaims(user, false); // false = acesso temporário

      if (autorizado) {
        console.log('Acesso autorizado!');
      } else {
        console.warn('Acesso pendente, liberado temporariamente.');
      }
